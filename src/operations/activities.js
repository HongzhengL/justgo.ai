...
export const getActivities = async ({ location, date, timeOfDay, interests = [] }, context) => {
  ...
  const isMumbaiClubbing = interests.some(interest => 
  ...
  if (isMumbaiClubbing) {
    ...
    const mumbaiClubs = [
      ...
      },
      {
        ...
        externalLinks: [
          { label: "Zomato", url: "https://www.zomato.com/mumbai/kitty-su-andheri-east/info" }
        ]
      },
      {
        id: 3,
        ...
        externalLinks: [
          { label: "Zomato", url: "https://www.zomato.com/mumbai/bonobo-bandra-west/info" }
        ]
      },
      {
        id: 4,
        ...
        externalLinks: [
          { label: "Zomato", url: "https://www.zomato.com/mumbai/totos-garage-bandra-west/info" }
        ]
      },
      {
        id: 5,
        ...
        externalLinks: [
          { label: "Zomato", url: "https://www.zomato.com/mumbai/antisocial-khar-west/info" }
        ]
      }
    ];
...
Return pure JSON array, each object with id,title,subtitle,timing,price,bookingUrl,externalLinks.`;
  ...
  const resp = await openai.chat.completions.create({
    ...
    messages: [
      { 
        role: 'system', 
        content: 'You are a knowledgeable travel expert. You respond only with valid JSON containing actual, real venues and businesses. Never use generic placeholder names.'
      },
