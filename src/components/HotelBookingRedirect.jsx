...
export default function HotelBookingRedirect({ hotel, offer, guestInfo, onProceed }) {
  ...
  return (
    <div className="hotel-booking-redirect" style={{ maxWidth: 480, margin: '2rem auto', padding: 24, border: '1px solid #eee', borderRadius: 8, background: '#fff' }}>
      ...
      <div>Price: <b>{offer.price?.currency} {offer.price?.total}</b></div>
